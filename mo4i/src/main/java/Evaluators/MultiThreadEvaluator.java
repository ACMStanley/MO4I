...
public class MultiThreadEvaluator<S> implements SolutionListEvaluator<S> {

	private static int evaluationsMade = 0;
	
	private final int numberOfThreads;

	public MultiThreadEvaluator(int numberOfThreads) {
	...
	public List<S> evaluate(List<S> solutionList, Problem<S> problem) {
		//evaluationsMade += solutionList.size();
		//System.out.println(evaluationsMade + "evalutions completed.");
