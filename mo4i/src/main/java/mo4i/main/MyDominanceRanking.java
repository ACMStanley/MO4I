...
public class MyDominanceRanking <S extends Solution<?>>
   ...
   * Constructor
   */
  public MyDominanceRanking(Comparator<S> comparator) {
   ...
   * Constructor
   */
  public MyDominanceRanking() {
    this(new DominanceComparator<>()) ;
  }

  public MyDominanceRanking(Object id) {
    super(id) ;
    rankedSubPopulations = new ArrayList<>();
  }
